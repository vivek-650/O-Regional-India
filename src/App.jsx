  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/tourist-dashboard" element={<PrivateRoute role="Tourist"><TouristDashboard /></PrivateRoute>} />
        <Route path="/tour-guide-dashboard" element={<PrivateRoute role="Tour Guide"><TourGuideDashboard /></PrivateRoute>} />
        <Route path="/business-dashboard" element={<PrivateRoute role="Business"><BusinessDashboard /></PrivateRoute>} />
